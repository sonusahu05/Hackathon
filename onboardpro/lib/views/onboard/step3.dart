...
//                   const threshold = 0.7;
//                   final matches = List.filled(secondEmbeddings.length, false);

//                   for (var i = 0; i < firstEmbeddings.length; i++) {
//                     for (var j = 0; j < secondEmbeddings.length; j++) {
//                       print('firstEmbeddings[i] ${firstEmbeddings[i]}');
//                       print('secondEmbeddings[j] ${secondEmbeddings[j]}');
//                       // final similarity = await firstEmbeddings[i]
//                       //     .cosineSimilarity(secondEmbeddings[j]);
...
//                   setState(() {
//                     isMatching = matches.contains(true);
//                   });
//                 }
//               },
//             ),
